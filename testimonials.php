...
$REVIEWS = [
    ...
    'cz' => [
        ['Eliška N.', 'Klientka, imigrační dokumenty, Praha', 'Naše vízové dokumenty byly přeloženy rychle a bez jediného problému přijaty. Jsem opravdu ráda, že jsem tento tým našla.', 5, '#1E3A8A'],
        ['Jakub T.', 'Provozní ředitel, Brno', 'Lokalizovali jsme celou sadu manuálů k produktu do šesti jazyků. Komunikace byla jasná od nabídky až po dodání.', 5, '#0F766E'],
        ['Petra S.', 'HR ředitelka, Ostrava', 'Certifikovaní překladatelé okamžitě pochopili naše požadavky na soulad s předpisy. Vřele doporučuji pro právní dokumenty.', 5, '#B45309'],
        ['Tomáš K.', 'Majitel malé firmy, Plzeň', 'Rychlé, vstřícné a ceny byly jasné hned od začátku, bez žádných překvapení. Toto je teď náš hlavní překladatelský partner.', 4, '#7E22CE'],
    ],
];
$reviews = $REVIEWS[$CURRENT_LANG] ?? $REVIEWS['en'];
?>
